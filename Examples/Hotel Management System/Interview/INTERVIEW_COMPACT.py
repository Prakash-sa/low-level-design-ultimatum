...
class Factory:
    ...
    def create_entity(entity_type: str = "primary", **kwargs):
        entity_class = Factory._entity_map.get(entity_type, Guest)
...
class HotelManagementSystemSystem:
    ...
    def get_instance(cls):
        if cls._instance is None:
            cls._instance = HotelManagementSystemSystem()
...
def demo_1_basic_setup():
    ...
    system = HotelManagementSystemSystem.get_instance()
    ...
    for i in range(3):
        ...
        system.add_entity(Guest(entity_id))
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("HOTEL MANAGEMENT SYSTEM - 75 MINUTE INTERVIEW")
    print("="*60)
