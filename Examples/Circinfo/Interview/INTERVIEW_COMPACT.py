"""
Circinfo - Interview Implementation
...
class Factory:
    ...
    def create_entity(entity_type: str = "primary", **kwargs):
        entity_class = Factory._entity_map.get(entity_type, Node)
...
def demo_1_basic_setup():
    ...
    system = CircinfoSystem.get_instance()
    ...
    for i in range(3):
        ...
        system.add_entity(Node(entity_id))
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("CIRCINFO - 75 MINUTE INTERVIEW")
    print("="*60)
