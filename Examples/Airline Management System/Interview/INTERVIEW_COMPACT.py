...
class Factory:
    ...
    def create_entity(entity_type: str = "primary", **kwargs):
        entity_class = Factory._entity_map.get(entity_type, Flight)
...
class AirlineManagementSystemSystem:
    ...
    def get_instance(cls):
        if cls._instance is None:
            cls._instance = AirlineManagementSystemSystem()
...
def demo_1_basic_setup():
    ...
    system = AirlineManagementSystemSystem.get_instance()
    ...
    for i in range(3):
        ...
        system.add_entity(Flight(entity_id))
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("AIRLINE MANAGEMENT SYSTEM - 75 MINUTE INTERVIEW")
    print("="*60)
