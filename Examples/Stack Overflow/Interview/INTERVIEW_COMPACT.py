...
class Factory:
    ...
    def create_entity(entity_type: str = "primary", **kwargs):
        entity_class = Factory._entity_map.get(entity_type, Question)
...
class StackOverflowSystem:
    ...
    def get_instance(cls):
        if cls._instance is None:
            cls._instance = StackOverflowSystem()
...
def demo_1_basic_setup():
    ...
    system = StackOverflowSystem.get_instance()
    ...
    for i in range(3):
        ...
        system.add_entity(Question(entity_id))
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("STACK OVERFLOW - 75 MINUTE INTERVIEW")
    print("="*60)
