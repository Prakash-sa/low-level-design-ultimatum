...
class Factory:
    ...
    def create_entity(entity_type: str = "primary", **kwargs):
        entity_class = Factory._entity_map.get(entity_type, Game)
...
class OnlineBlackjackGameSystem:
    ...
    def get_instance(cls):
        if cls._instance is None:
            cls._instance = OnlineBlackjackGameSystem()
...
def demo_1_basic_setup():
    ...
    system = OnlineBlackjackGameSystem.get_instance()
    ...
    for i in range(3):
        ...
        system.add_entity(Game(entity_id))
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("ONLINE BLACKJACK GAME - 75 MINUTE INTERVIEW")
    print("="*60)
