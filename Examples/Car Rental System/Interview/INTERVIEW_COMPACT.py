...
class Reservation:
    """Core entity: Reservation"""
    def __init__(self, id: str):
        self.id = id
        self.created_at = datetime.now()

class RentalLocation:
    """Core entity: RentalLocation"""
    def __init__(self, id: str):
        self.id = id
        self.created_at = datetime.now()
...
class Factory:
    ...
    def create_entity(entity_type: str = "primary", **kwargs):
        entity_class = Factory._entity_map.get(entity_type, Vehicle)
...
class CarRentalSystemSystem:
    ...
    def get_instance(cls):
        if cls._instance is None:
            cls._instance = CarRentalSystemSystem()
...
def demo_1_basic_setup():
    ...
    system = CarRentalSystemSystem.get_instance()
    ...
    for i in range(3):
        ...
        system.add_entity(Vehicle(entity_id))
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("CAR RENTAL SYSTEM - 75 MINUTE INTERVIEW")
    print("="*60)
