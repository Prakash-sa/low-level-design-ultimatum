"""
Meeting Scheduler - Interview Implementation
...
class Factory:
    ...
    def create_entity(entity_type: str = "primary", **kwargs):
        entity_class = Factory._entity_map.get(entity_type, Meeting)
...
class MeetingSchedulerSystem:
    ...
    def get_instance(cls):
        if cls._instance is None:
            cls._instance = MeetingSchedulerSystem()
...
def demo_1_basic_setup():
    ...
    system = MeetingSchedulerSystem.get_instance()
    ...
    for i in range(3):
        ...
        system.add_entity(Meeting(entity_id))
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("MEETING SCHEDULER - 75 MINUTE INTERVIEW")
    print("="*60)
