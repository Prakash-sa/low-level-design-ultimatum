...
class Factory:
    ...
    def create_entity(entity_type: str = "primary", **kwargs):
        entity_class = Factory._entity_map.get(entity_type, Board)
...
def demo_1_basic_setup():
    ...
    system = ChessGameSystem.get_instance()
    ...
    for i in range(3):
        ...
        system.add_entity(Board(entity_id))
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("CHESS GAME - 75 MINUTE INTERVIEW")
    print("="*60)
