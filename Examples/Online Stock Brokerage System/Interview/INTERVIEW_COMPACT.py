"""
Online Stock Brokerage System - Interview Implementation
...
class Factory:
    ...
    def create_entity(entity_type: str = "primary", **kwargs):
        entity_class = Factory._entity_map.get(entity_type, Stock)
...
class OnlineStockBrokerageSystemSystem:
    ...
    def get_instance(cls):
        if cls._instance is None:
            cls._instance = OnlineStockBrokerageSystemSystem()
...
def demo_1_basic_setup():
    ...
    system = OnlineStockBrokerageSystemSystem.get_instance()
    ...
    for i in range(3):
        ...
        system.add_entity(Stock(entity_id))
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("ONLINE STOCK BROKERAGE SYSTEM - 75 MINUTE INTERVIEW")
    print("="*60)
