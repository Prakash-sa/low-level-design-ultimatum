"""
Jigsaw Puzzle - Interview Implementation
...
class Factory:
    ...
    def create_entity(entity_type: str = "primary", **kwargs):
        entity_class = Factory._entity_map.get(entity_type, Piece)
...
class JigsawPuzzleSystem:
    ...
    def get_instance(cls):
        if cls._instance is None:
            cls._instance = JigsawPuzzleSystem()
...
def demo_1_basic_setup():
    ...
    system = JigsawPuzzleSystem.get_instance()
    ...
    for i in range(3):
        ...
        system.add_entity(Piece(entity_id))
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("JIGSAW PUZZLE - 75 MINUTE INTERVIEW")
    print("="*60)
