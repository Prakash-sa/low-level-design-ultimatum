...
class Factory:
    ...
    def create_entity(entity_type: str = "primary", **kwargs):
        entity_class = Factory._entity_map.get(entity_type, Locker)
...
class AmazonLockerSystemSystem:
    ...
    def get_instance(cls):
        if cls._instance is None:
            cls._instance = AmazonLockerSystemSystem()
...
def demo_1_basic_setup():
    ...
    system = AmazonLockerSystemSystem.get_instance()
    ...
    for i in range(3):
        ...
        system.add_entity(Locker(entity_id))
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("AMAZON LOCKER SYSTEM - 75 MINUTE INTERVIEW")
    print("="*60)
