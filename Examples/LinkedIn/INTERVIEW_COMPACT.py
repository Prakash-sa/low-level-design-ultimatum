"""
LinkedIn - Interview Implementation
...
class JobPosting:
    """Core entity: JobPosting"""
    def __init__(self, id: str):
        self.id = id
        self.created_at = datetime.now()

class Recommendation:
    """Core entity: Recommendation"""
    def __init__(self, id: str):
        self.id = id
        self.created_at = datetime.now()
...
class Factory:
    ...
    def create_entity(entity_type: str = "primary", **kwargs):
        entity_class = Factory._entity_map.get(entity_type, Profile)
...
def demo_1_basic_setup():
    ...
    for i in range(3):
        ...
        system.add_entity(Profile(entity_id))
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("LINKEDIN - 75 MINUTE INTERVIEW")
    print("="*60)
