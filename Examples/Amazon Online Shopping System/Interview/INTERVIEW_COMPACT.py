...
class Factory:
    ...
    def create_entity(entity_type: str = "primary", **kwargs):
        entity_class = Factory._entity_map.get(entity_type, Product)
...
class AmazonOnlineShoppingSystemSystem:
    ...
    def get_instance(cls):
        if cls._instance is None:
            cls._instance = AmazonOnlineShoppingSystemSystem()
...
def demo_1_basic_setup():
    ...
    system = AmazonOnlineShoppingSystemSystem.get_instance()
    ...
    for i in range(3):
        ...
        system.add_entity(Product(entity_id))
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("AMAZON ONLINE SHOPPING SYSTEM - 75 MINUTE INTERVIEW")
    print("="*60)
